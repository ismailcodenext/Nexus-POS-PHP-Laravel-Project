...
<head>
   ...
   <link
   href="{{asset('back-end/assets/css/sign-in.css')}}"
   id="app-style"
   rel="stylesheet"
   type="text/css"
 />
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="dropdown d-inline-block language-switch">
          ...
          <div class="dropdown-menu dropdown-menu-end">
            ...
            >
              <img
                src="./back-end/assets/img/flags/spain.jpg"
                alt="user-image"
                class="me-1"
                height="12"
              />
            ...
            >
              <img
                src="./back-end/assets/img/flags/germany.jpg"
                alt="user-image"
                class="me-1"
                height="12"
              />
            ...
            >
              <img
                src="./back-end/assets//img/flags/italy.jpg"
                alt="user-image"
                class="me-1"
                height="12"
              />
            ...
            >
              <img
                src="./back-end/assets/img/flags/russia.jpg"
                alt="user-image"
                class="me-1"
                height="12"
              />
              ...
              <a href="#!" class="text-reset notification-item">
                <div class="d-flex">
                  <div class="flex-shrink-0 me-3">
                    <img
                      src="./back-end/assets/img/navbar-profile-logo.png"
...
></script>
<script src="{{asset('back-end/assets/js/dethpicker.js')}}" type="text/javascript"></script>
...
{{--
    <script>
        async function userlogout() {
            ...
            try {
                let res = await axios.get("/nexus-logout-page", HeaderToken());
                localStorage.clear();
