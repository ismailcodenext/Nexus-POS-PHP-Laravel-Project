        ...
        <div class="page-content">
          ...
          <section id="data_table">
            <div class="button-container">
              <div class="search-item">
                ...
                <div class="dropdown">
                  ...
                  <div id="dropdownMenuCustom" class="dropdown-menu-custom">
                    <a class="dropdown-item-custom" href="#" data-value="all"
                      >All time</a
                    >
                    <a class="dropdown-item-custom" href="#" data-value="7days"
                      >Last 7 days</a
                    >
                    <a class="dropdown-item-custom" href="#" data-value="month"
                      >Last month</a
                    >
                    <a class="dropdown-item-custom" href="#" data-value="year"
                      >Last year</a
                    >
                  </div>
                </div>
              ...
              <div class="file-export-item">
                ...
                <!-- Custom buttons -->
                <button id="excelButton" class="dt-button">
                  <svg
                    width="44"
                    height="44"
                    viewBox="0 0 44 44"
                ...
                <button id="csvButton" class="dt-button">
                  <svg
                    width="44"
                    height="44"
                    viewBox="0 0 44 44"
                ...
                <button id="pdfButton" class="dt-button">
                  <svg
                    width="44"
                    height="44"
                    viewBox="0 0 44 44"
                ...
                <button id="copyButton" class="dt-button">
                  <svg
                    width="44"
                    height="44"
                    viewBox="0 0 44 44"
                ...
                <button id="printButton" class="dt-button">
                  <svg
                    width="44"
                    height="44"
                    viewBox="0 0 44 44"
            ...
            <div class="custom-pagination">
              <button id="prevPage" class="disabled button">Prev</button>
                  ...
                  <div class="datepicker-wrapper">
                    ...
                    <div class="controls datepick_wrap">
                      ...
                      <label class="calander-icon" for="datepicks"
                        ><img src="./back-end/assets/icons/calender.svg" alt=""
                      /></label>
                    </div>
                  </div>
